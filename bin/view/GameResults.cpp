...
GameResults::GameResults(int completed):
    fontLoaded(false),
    completedTasks(completed)
{
    ...
    if (fontLoaded) 
    {
        ...
        completedTasksText = std::make_unique<sf::Text>(font, "Completed tasks " + std::to_string(completedTasks), 60);
        completedTasksText->setPosition({50.f, 190.f});
